...
class JsonHttpsClientUtf8Impl implements JsonHttpClient{
	 ...
	 */
	protected JsonHttpsClientUtf8Impl(URL url, GsonBuilder gsonbuilder, Map<String, String> headerOptions,String method){
		this.url = url;
	 ...
	 */
	protected JsonHttpsClientUtf8Impl(URL url, String proxy_server, String proxy_user, String proxy_passwd, Integer proxy_port, GsonBuilder gsonbuilder, Map<String, String> headerOptions, String method){
		this.url = url;
