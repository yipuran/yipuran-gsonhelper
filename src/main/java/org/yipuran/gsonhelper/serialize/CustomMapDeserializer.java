...
/**
 * キー指定 Map＜String, Object＞用、JsonDeserializer.
 * <PRE>
 ...
 *     .registerTypeAdapter(new TypeToken&lt;Map&lt;String, Object&gt;&gt;(){}.getType(), new CustomMapDeserializer())
 ...
 *     CustomMapDeserializer gmds = new CustomMapDeserializer();
